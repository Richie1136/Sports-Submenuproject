  ...
  return (
    <div className='kc'>
      ...
      <p className='perez'>
        ...
        Salvador Perez was signed by the Royals in 2006.
        Salvador Perez is a seven-time Mlb All-Star; five-time Gold Glove Award winner; four-time Silver Slugger Award winner.
        Perez has a career .270 BA 200 HR .302 OBP .463 SLG .765 OPS.
      </p>
      <img className='img1' src={logo} alt='img1' />
      <br />
      <p className='merrifield'>
        Whit Merrifield is a second baseman and outfielder.
