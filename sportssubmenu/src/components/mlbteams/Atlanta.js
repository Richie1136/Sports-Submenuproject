...
const Atlanta = () => {
  return (
    <div className='atl'>
      ...
      <p className='braves'>The Atlanta Braves are a Major League Baseball team. They are based in Atlanta, Georgia.
        They are a member of the Eastern Division of Major League Baseball's National League. The Braves colors
        are Scarlett, Navy, Gold and White. The braves are the only existing major league franchise to have played every season since professional baseball came to existence. The Braves have been apart of the Major Leagues since 1961. The Atlanta
        Braves finished the regular season with a 88-73 record and have advanced to the National League Championship Series and will face either the LA Dodgers or SF Giants. </p>
      <br />
      <p className='acuna'>
        ...
        Ronald Acuna is an Major League Baseball outfielder for the Atlanta Braves.
        Acuna is a two-time Mlb All-Star; 2018 National League Rookie of the Year, and is an two-time winner of the Silver Slugger Award.
      ...
      <p className='freeman'>
        ...
        Freddie Freeman is a five-time Mlb All-Star; two-time winner of the Silver Slugger Award and a one-time National League Most Value Player.
