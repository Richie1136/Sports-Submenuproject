...
import logo5 from '../../images/verlander.png'
...
const Mlb = () => {
  return (
    <div className='mlb'>
      ...
      <p className='alw'>
        The American League West is one of six divisions in the Major League Baseball and is the last division in the American League. The AL West division was founded in 1969.The division has five teams since the 2013 season, but had four teams from 1994 to 2012.
      ...
      <p className='nle'>
        The National League East is one of six divisions in the Major League Baseball. The NL East division was founded in 1969.Along with the American League Central it is one of two divisions to have every member win at least one World Series title.
