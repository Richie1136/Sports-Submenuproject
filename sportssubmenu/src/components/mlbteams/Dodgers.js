  ...
  return (
    <div className='lad'>
      ...
      <p className='dodgers'>The Los Angeles Dodgers are a Major League Baseball team. They are based in Los Angeles, Ca.
        ...
        are Dodger Blue, and Silver. The Dodgers were founded in 1883.
      ...
      <p className='scherzer'>
        ...
        Max Scherzer is a eight-time Mlb All-Star; three-time CY Young Award winner.
      ...
      <p className='betts'>
        ...
        Mookie Betts 5-time Mlb All-Star; 2018 American League Most Valuable Player; five-time Gold Glove Award winner; four-time Silver Slugger Award winner.
