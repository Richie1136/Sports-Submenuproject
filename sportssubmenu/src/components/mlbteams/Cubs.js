...
const Cubs = () => {
  return (
    <div className='chc'>
      <h1>Chicago Cubs</h1>
      <p className='cubs'>The Chicago Cubs are a Major League Baseball team. They are based in Chicago, IL.
        They are a member of the Central Division of Major League Baseball's National League. The Cubs colors
        are Blue, and Red. The Cubs were founded in 1870.
      ...
      <p className='contreras'>
        ...
        Willson Contreras was signed by the Cubs in July of 2009 as a third baseman.
        Contreras is a two-time Mlb All-Star; 2017 August 6th NL Player of the Week.
