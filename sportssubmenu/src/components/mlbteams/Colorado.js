...
const Colorado = () => {
  return (
    <div className='col'>
      ...
      <p className='rockies'>The Colorado Rockies are a Major League Baseball team. They are based in Denver, CO.
        They are a member of the West Division of Major League Baseball's National League. The Rockies colors
        are Rockies Purple, Silver, and Midnight Black. The Rockies were founded in 1991.
      ...
      <p className='cron'>
        ...
        CJ Cron is a first baseman.
        CJ Cron's accolades are 2021 August NL Player of the Month and 2021 August 8th NL Player of the Week.
